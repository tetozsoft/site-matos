...
|---|---|---|
| `NEXT_PUBLIC_CDN_URL` | URL base da CDN (Cloudflare R2) | `https://cdn.tetoz.com.br` |
...
echo "https://cdn.tetoz.com.br" | vercel env add NEXT_PUBLIC_CDN_URL production
echo "https://cdn.tetoz.com.br" | vercel env add NEXT_PUBLIC_CDN_URL preview
